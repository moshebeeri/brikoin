...
exports.flexVideoToken = functions.database.ref(`server2/operations/events/flexVideoTokenTrigger`).onWrite((change, context) => __awaiter(this, void 0, void 0, function* () {
}));
...
router.route('/chatToken/:identify/:deviceId')
    ...
    // Create an access token which we will sign and return to the client,
    // containing the grant we just created
    let token = new AccessToken('ACde9becade1257930f33203e0cfaaa26d', 'SK85e7a31c2e5c92b9982b5ee92cf481b3', 'jMOUpsb5IfSJrQkFam6o2E3MzltX0QYDx');
...
router.route('/taskVideo/:roomName/:clientId')
    ...
    let task = yield client.taskrouter.workspaces('WS682d1bb75e15d856a81592f746786152')
        .tasks
...
//# sourceMappingURL=flexOperations.js.map