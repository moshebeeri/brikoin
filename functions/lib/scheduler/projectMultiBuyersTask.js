...
function triggerProjectMultiBuyerCondition(task) {
    return __awaiter(this, void 0, void 0, function* () {
        return true;
    });
}
exports.triggerProjectMultiBuyerCondition = triggerProjectMultiBuyerCondition;
function triggerProjectMultiBuyerRun(task) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log('BID');
        let response = yield wallet_1.projectBidRequest(userAccount.accountId, order.project, order.amount, order.price, 0);
...
exports.triggerProjectMultiBuyerRun = triggerProjectMultiBuyerRun;
...
//# sourceMappingURL=projectMultiBuyersTask.js.map