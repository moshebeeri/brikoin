...
function calculate (req) {
    ...
    let amortizations = <any> calculateMortgagePayments(mortgageCondition)
    return JSON.stringify(amortizations);
}

export function calculateMortgagePayments(mortgageCondition){
    let amortizations = <any> calculateMortgage({
...
export function getCondition(mortgageType, month, amount, armInterestRate, fixedInterestRate){
    let mortgageCondition = <any> {};
