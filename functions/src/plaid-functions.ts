...
const plaidClient = new plaid.Client('5b35001b64b5a20011aea64e',
    functions.config().plaid.token,
    'dee1972b42cd7c46291cb03ad8d7aa',
...
export function handlePlaidRequest(db,req,res){
    try {
