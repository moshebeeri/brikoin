...
contract("Mortgagee", function(accounts) {
  ...
  before(async () => {
    ...
    mortgageOwner = await mortgageRequestFactory.owner();
  ...
  it("should  approved admin", async () => {
    try {
      await mortgageRequestFactory.approveByAdmin(mortgageeRequestAddress, {
        from: mortgageOwner
      });
      mortgageeRequestCon = MortgageRequest.at(mortgageeRequestAddress);
      let approved = await mortgageeRequestCon.isApproved();
  ...
  it("create mortgage should fail ", async () => {
    try {
      let createdMortgage = await mortgageFactory.createMortgage(
        user1,
        testStoneCoinAddress,
  ...
  it("create mortgage should fail ", async () => {
    try {
      await mortgageRequestFactory.cancelMortgageCondition(
        mortgageeConditionAddress,
        { from: user1 }
      );
      let createdMortgage = await mortgageFactory.createMortgage(
