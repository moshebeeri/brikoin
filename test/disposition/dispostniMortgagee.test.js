...
contract("Disposition Mortgage", function(accounts) {
  let cornerStone;
  let mortgageFactory;
  ...
  it("should fail", async () => {
    try {
      await cornerStone.setUserDispositionState(user2, true);
  ...
  it("create bid mortgage ", async () => {
    await cornerStone.setUserDispositionState(user2, false);
  ...
  it("should fail", async () => {
    try {
      await cornerStone.setUserDispositionState(user0, true);
  ...
  it("create trade mortgage ", async () => {
    await cornerStone.setUserDispositionState(user0, false);
