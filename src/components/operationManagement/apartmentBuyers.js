...
class ApartmentBuyers extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      approveDialog: false,
  ...
  getCaseId() {
    return this.props.location.pathname.substring(23)
      ? this.props.location.pathname.substring(23)
      : "";
  }
}

ApartmentBuyers.propTypes = {
...
export default withStyles(styles)(
  connect(mapStateToProps, mapDispatchToProps)(ApartmentBuyers)
);
