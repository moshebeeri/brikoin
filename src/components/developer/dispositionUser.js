...
import { setDispositionState } from "../../redux/actions/admin";
...
class DepositPayment extends React.Component {
  ...
  selectProject(event) {
    this.setState({
      dispositionState: event.target.value
    });
  }

  disposition() {
    const { setDispositionState } = this.props;
    setDispositionState(this.state.userId, this.state.dispositionState);
  }
            ...
            >
              ...
              >
                ...
                <FormControl className={classes.textField}>
                  ...
                  <Select
                    value={this.state.dispositionState}
...
export default withStyles(styles)(
  connect(mapStateToProps, mapDispatchToProps)(DepositPayment)
);
