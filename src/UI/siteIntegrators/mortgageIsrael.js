...
class MortgageIsrael extends React.Component {
  constructor(props) {
    super(props);
          ...
          <CardActionArea onClick={this.openPopup.bind(this)}>
            ...
            >
              ...
              >
                ...
                >
                  {this.props.t("Compare Banks Mortgages")}
                </Typography>
              </div>
            </div>
          </CardActionArea>
...
export default withProject(MortgageIsrael);
