...
import { createVideoTask, movedToVideo } from "./redux/actions/video";
...
The following div element shows all remote media (other                             participant’s tracks)
  ...
  joinRoom() {
    ...
    const room = "customer" + new Date().getTime();
    let connectOptions = {
      name: room,
      video: { width: 380, height: 350 }
    };
...
*/
    ...
    this.props.createVideoTask(room, "MyId");
  }
...
*/
  ...
  componentDidUpdate() {
    if (this.props.moveToVideo && this.props.channelId) {
      this.props.movedToVideo();
      this.moveToVideo();
    }
  }
}
...
const mapStateToProps = (state, props) => ({
  moveToVideo: state.video.moveToVideo,
